...
class People(models.Model):
    addressPeople = models.CharField(max_length=200, null=True)
    birthdayPeople = models.DateField(default=None)
    numberPeople = models.CharField(max_length=10, null=True)  # Keep as CharField if it includes non-numeric characters
