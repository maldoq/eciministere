"""
Django settings for eciminister project.
...
SECRET_KEY = 'django-insecure-)xug5$)at&1bdsc+6i0_)$&qcd39f70r9e#7(3(*w#r@zcf@r('
...
# For production, you may want to set this to a different directory
